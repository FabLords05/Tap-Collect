              ...
              SliverPadding(
                ...
                sliver: SliverList(
                  delegate: SliverChildListDelegate([
                    PointsCard(points: _pointsBalance, isLoading: _isLoading),
                    ...
                    if (!_isBusinessActivated)
                      ...
                      NFCCollectionWidget(onPointsCollected: _onPointsCollected),
                    ...
                    if (_isLoading)
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            Icon(Icons.history_outlined, size: 48, color: theme.colorScheme.onSurface.withOpacity(0.4)),
                            const SizedBox(height: 16),
                            Text(
                              'No activity yet',
                      ...
                      ...List.generate(
                        ...
                        (index) => Padding(
                          ...
                          child: RecentActivityCard(transaction: _recentTransactions[index]),
                        ),
                      ),
                      ...
                      children: [
                        ...
                        Expanded(
                          child: _buildQuickActionCard(
                            ...
                            onTap: () {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(content: Text('Business finder coming soon!')),
                              );
                            },
                          ),
                        ),
                    ...
                    _buildFullWidthActionCard(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const VisitedBusinessesScreen(),
                          ),
                        );
                      },
                    ),
